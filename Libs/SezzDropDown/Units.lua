...
local tMenuItems = {
	-- Markers
	{
		...
		Children = {
			...
			{
				Name = "BtnMark1",
				Text = "Icon_Windows_UI_CRB_Marker_Bomb",
				OnClick = "OnClickUnit",
			},
			{
				Name = "BtnMark2",
				Text = "Icon_Windows_UI_CRB_Marker_Ghost",
				OnClick = "OnClickUnit",
			},
			{
				Name = "BtnMark3",
				Text = "Icon_Windows_UI_CRB_Marker_Mask",
				OnClick = "OnClickUnit",
			},
			{
				Name = "BtnMark4",
				Text = "Icon_Windows_UI_CRB_Marker_Octopus",
				OnClick = "OnClickUnit",
			},
			{
				Name = "BtnMark5",
				Text = "Icon_Windows_UI_CRB_Marker_Pig",
				OnClick = "OnClickUnit",
			},
			{
				Name = "BtnMark6",
				Text = "Icon_Windows_UI_CRB_Marker_Chicken",
				OnClick = "OnClickUnit",
			},
			{
				Name = "BtnMark7",
				Text = "Icon_Windows_UI_CRB_Marker_Toaster",
				OnClick = "OnClickUnit",
			},
			{
				Name = "BtnMark8",
				Text = "Icon_Windows_UI_CRB_Marker_UFO",
				OnClick = "OnClickUnit",
			},
			{
				Name = "BtnMarkClear",
